...
## 大規模サービスへのチャレンジ
- 今までの業務ではPocの開発運用保守業務が中心で多くのアクティブユーザーを抱えるサービスを扱った経験がない
- PoCと多くのアクティブユーザーを抱えるプロダクトでは開発の考え方なども変わってくるのではと考えている。
- 貴社のプロダクトはある程度のユーザーが利用されることが担保されるように感じている。
- そのため、経験したことのない多くのアクティブユーザーを抱えるサービスに携わり、エンジニアとして視座を高め、奥行きを広めたいと感じている。

## 経験したことを生かしつつも新しい領域へのチャレンジ/従業員の数だけあるキャリアパス(個の尊重)
